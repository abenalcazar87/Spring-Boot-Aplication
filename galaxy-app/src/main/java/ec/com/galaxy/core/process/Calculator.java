...
public static final ErrorMessage eMessage = new ErrorMessage();
	...
	public static String romanToArabic(String roman) throws RomanException, LineViolationException {
		String result="";
		...
		switch(validateRomanNumber(roman))
		{
			...
			default : result = Calculator.eMessage.getMessage(ErrorProcess.INVALID_ROMAN_STRING);
		}
